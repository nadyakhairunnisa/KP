...
<nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="navbar-header">
          ...
          <div id="navbar" class="navbar-collapse collapse navbar-right">
            <ul class="nav navbar-nav">
                ...
                <li><a href="kelola_perkembangan.html" class="page-scroll">PERKEMBANGAN</a></li>                
      ...
      <h1 style="text-align: center; margin-top:85px; color:black;">Tambah Data Dokter</h1>
        <form style="margin-top:50px;" action="proses/tambah_dokter.php" method="POST" enctype="multipart/form-data">
            <label>Nama</label> <br>
                <input id="nama" name="nama" type="text" placeholder="Nama" maxlength="50" required> <br>
            <label>HP</label> <br>
                <input id="no_hp" name="no_hp" type="text" placeholder="No HP" maxlength="50" required> <br>
            <label>Alamat</label> <br>
                <textarea style="width:55%;" id="alamat" name="alamat"></textarea> <br>
            <button type="submit" name="add"><div class="btn">Submit</div></button></a>
