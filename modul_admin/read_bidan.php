      ...
      <h1 style="text-align: center; margin-bottom:30px;">Kelola Data Bidan</h1>
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td>$tanggal</td>";
            echo "<td>
             <a href='edit_bidan.php?id=$id' type='button' class='btn btn-info btn-lg' data-toggle='modal'> Edit </a>
            <a href='proses/bidan/delete_bidan.php?id=$id' type='button' class='btn btn-info btn-lg' data-toggle='modal' onclick='return konfirmasi_hapus()'> Delete </a>
          </td>";
