      ...
      <table>
        ...
        <tbody>
          <?php
            ...
            echo "<td>$nama</td>";
            echo "<td>
            <a href='read_profil.php?id=$id' type='button' class='btn btn-info btn-lg' data-toggle='modal'> Profil </a>
            <a href='reas_perkembangan.php?id=$id' type='button' class='btn btn-info btn-lg' data-toggle='modal'> Perkembangan </a>
          </td>";
