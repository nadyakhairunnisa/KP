      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <div id="navbar" class="navbar-collapse collapse navbar-right">
            ...
            ?>
                <li><?php $user_id=$_GET['id']; echo ("<a href='home_dokter.php?id=$user_id' class='page-scroll top'>HOME</a>"); ?></li> 
                <li><?php $user_id=$_GET['id']; echo ("<a href='profil_dokter.php?id=$user_id' class='page-scroll top'>PROFIL</a>"); ?></li>                        
                <li><a href="login_dokter.php" class="page-scroll">Sign-Out</a></li>                
            </ul>              
          </div>        
        </div>        
      </nav>
      ...
      <div id="page-profil">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($result)){
                  ...
                  echo "<a href='edit_profil_dokter.php?id=$row[id]'style='color:white;'<button class='btn btn-info btn-lg' data-toggle='modal'>Edit</button> </a>"; 
