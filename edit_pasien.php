        ...
        <form action="proses/pasien/update_pasien.php" method="POST"  enctype="multipart/form-data"style="margin-top:50px;">
          <label>Nama</label> <br>
            ...
            <label>No. Handphone</label> <br>
                <input id="no_hp" name="no_hp" type="text" placeholder="No. HP" maxlength="15" vaue="<?php echo $pasien['no_hp'];?>"> <br>
             <label>Alamat</label> <br>
                <textarea id="alamat" name="alamat" style="width:55%;" value="<?php echo $pasien['alamat'];?>"></textarea> <br>  
            ...
            <label>Golongan Darah</label> <br>
             >  <input id="gol_darah" name="gol_darah" type="text" placeholder="Golongan Darah" value="<?php echo $pasien['gol_darah'];?>"> <br>
             <!--  <div class="form-group" style="margin:0px 100px;">
                  <label for="sel1"></label>
                   <select class="form-control" id="sel1"> 
                    <option id="gol_darah" >A</option>
                    <option id="gol_darah" >B</option>
                    <option id="gol_darah" >AB</option>
                    <option id="gol_darah" >O</option>
                  </select>
                </div>  -->
            <label>Usia</label> <br>
            ...
            <label>Nama Dokter</label> <br>
              <input id="nama_dokter" name="nama_dokter" type="text" placeholder="Nama Dokter" value="<?php echo $pasien['nama_dokter'];?>"> <br>
               <!--  <div class="form-group" style="margin:0px 100px;">
                  <label for="sel1"></label>
                  <select class="form-control" id="sel1">
